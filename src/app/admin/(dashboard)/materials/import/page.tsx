...
export default async function MaterialImportPage({ searchParams }: { searchParams: Promise<Query> }) {
  ...
  return <>
    ...
    <div className="max-w-4xl p-5 sm:p-8">
      ...
      {query.imported && <div className="mb-5 rounded-md border border-teal-200 bg-teal-50 p-4 text-sm text-teal">
        <p className="font-bold">CSV取込が完了しました。</p>
      ...
      <form action={importMaterialsCsvAction} className="card p-5 sm:p-7">
        <h2 className="text-lg font-bold text-navy">CSVファイル</h2>
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2">
          ...
          <label className="flex items-center gap-3 self-end rounded-md border border-line p-3.5 text-sm font-bold text-navy"><input className="size-4 accent-teal" type="checkbox" name="defaultPublished" />新規教材を公開する</label>
        </div>
      ...
      <section className="card mt-6 p-5 sm:p-7">
        <h2 className="font-bold text-navy">対応している列</h2>
